...
class GUI():
    ...
    CHANNELS = [
        ...
        ['Counter Strike Command',(LOG_PATH + 'csCommand.txt'),(),(CS_CMD),(["Central Command","Counter Strike Commanding Officer","Counter Strike Executive Officer","Counter Strike Chief Training Officer","Counter Strike Platoon Leader"]),(""),(LOGS + 'csCommand.txt'),('csCommand.txt'),('command'),(["Counterstrike Global Offense"]),([])],
